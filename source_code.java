...
public class TelesciCalculator extends JPanel {
    ...
    private JLabel bookmarkListTitleText;
    ...
    public TelesciCalculator() {
        ...
        bookmarkListTitleText = new JLabel("Bookmark List:");
        ...
        bookmarkListTitleText.setToolTipText("Every bookmark saved locally appears under here.");
        ...
        bookmarkListTitleText.setBounds(507, 20, 145, 25);
